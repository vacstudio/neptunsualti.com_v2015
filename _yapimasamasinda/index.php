            ...
            <div class="timer-container row-fluid">
                ...
                <div class="span8">
                    <div align="center" class="timer">
                        <span class="days"></span> GÜN
                        <span class="hours"></span> SAAT
                        <span class="minutes"></span> DAKİKA
                        <span class="seconds"></span> SANİYE
                    </div>
					<h2>İletişim</h2>
					<!--p><b>Nevcan Uludaş</b></p>
					<p>GSM          : 0 555 543 51 44</p-->
					<p style="margin-top:20px;">e-Posta    : info@neptunsualti.com</p>
				</div>
			</div>

<? include("system-assets/include/footer.php"); ?>
