            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="member-box-wrapper" data-uk-scrollspy="{cls:'uk-animation-slide-top', delay:1100}">
                    <div class="member-box">
                        ...
                        <div class="member-title">
                            <h4>Kurucu (Enez) / 1*Eğitmen<br/></h4>
                        </div>
                        <div class="member-social">
                            <ul>
                    ...
                    <div class="member-box">
                        ...
                        <div class="member-social">
                            <ul>
                                ...
                                <li><a href="mailto:iletisim@neptunsualti.com" title="iletisim@neptunsualti.com" data-placement="top" data-rel="tooltip"><i class="fa fa-envelope"></i></a></li>
