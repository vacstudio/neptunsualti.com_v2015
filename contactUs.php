        ...
        <div class="row">
            ...
            <form role="form" id="form" class="contactForm" method="post" action="https://webtools.vacstudio.com/contact-forms/neptunsualticom-bizeulasin.php">
                ...
                <div class="col-md-6">
                    ...
                    <div class="g-recaptcha" data-theme="light" data-sitekey="6Ld_7hAUAAAAAFaQFgDNGdJoUk91hgvd8HMNEdJy" style="transform:scale(0.77);-webkit-transform:scale(0.77);transform-origin:0 0;-webkit-transform-origin:0 0;"></div>
                    <div  data-uk-scrollspy="{cls:'uk-animation-slide-right', delay:500}">
                        <button type="submit" class="btn btn-lg btn-nesto submit">Gönder</button>
                    </div>
                </div>
            </form>
            <div class="col-md-12">
                <div class="section-desc">
                    ...
                    <p><b>Ender Özgen</b> +90 505 355 4853 (Enez / Edirne)</p>
                    <hr />
                </div>
            </div>
        </div>
